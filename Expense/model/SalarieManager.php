...
class SalarieManager extends Database
{
    ...
    public function create(Salarie $salarie){
        $sql="INSERT INTO salarie (salId, salFonction, salNom, salPrenom, salMail, salMdp, entSiret) 
        VALUES (:salId, :salFonction, :salNom, :salPrenom, :salMail, :salMdp, :entSiret)";
        $req=$this->db->prepare($sql);
        $req->bindValue(':salId',$salarie->getSalId(),PDO::PARAM_INT);
        $req->bindValue(':salFonction',$salarie->getSalFonction(),PDO::PARAM_STR);
        $req->bindValue(':salNom',$salarie->getSalNom(),PDO::PARAM_STR);
    ...
    public function read(int $id){
        ...
        $req = $this->db->prepare($sql);
        $req->bindValue(':salId',$id,PDO::PARAM_INT);
        $req->execute();
